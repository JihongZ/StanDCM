...
parameters{
 ...
 vector[Ni] sParm;
  ...
  sParm[1]=1-inv_logit(l1_0+l1_11+l1_13+l1_213);
  sParm[2]=1-inv_logit(l2_0+l2_11+l2_13+l2_213);
  sParm[3]=1-inv_logit(l3_0+l3_12+l3_13+l3_223);
  sParm[4]=1-inv_logit(l4_0+l4_12+l4_13+l4_223);
  sParm[5]=1-inv_logit(l5_0+l5_13);
  sParm[6]=1-inv_logit(l6_0+l6_13);
  sParm[7]=1-inv_logit(l7_0+l7_11+l7_12+l7_13+l7_212+l7_213+l7_223+l7_3123);
