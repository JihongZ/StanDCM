...
parameters{
  ...
  PImat[2,4]=inv_logit(l2_0);
  PImat[3,4]=inv_logit(l3_0+l3_12);
  PImat[4,4]=inv_logit(l4_0+l4_12);
  ...
  PImat[2,6]=inv_logit(l2_0+l2_11);
  ...
  PImat[1,8]=inv_logit(l1_0+l1_11);
  PImat[2,8]=inv_logit(l2_0+l2_11);
  PImat[3,8]=inv_logit(l3_0+l3_12);
  PImat[4,8]=inv_logit(l4_0+l4_12);
